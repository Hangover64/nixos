...
All instructions can be found at [draculatheme.com/](https://draculatheme.com/starship-powerline-preset).

## Team

This theme is maintained by the following person(s) and a bunch of [awesome contributors](https://github.com/dracula/starship-powerline-preset/graphs/contributors).
